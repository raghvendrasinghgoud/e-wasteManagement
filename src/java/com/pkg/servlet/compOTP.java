...
public class compOTP extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(sysOTP+"is system generated otp");
        String userOTP=request.getParameter("getotp");
        System.out.println(userOTP+"is user generated otp");
        if(new Mail().compOTP(sysOTP, userOTP))
            response.sendRedirect("Register");
        else {
            String msg=session.getAttribute("error").toString();
            System.out.println(msg+" is the error mesaage");
