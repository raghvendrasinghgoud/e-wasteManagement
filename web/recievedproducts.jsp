...
<%@page import="com.pkg.entities.recievedProducts"%>
<%@page import="com.pkg.dao.recievedProductsDAO"%>
...
<html>
  ...
  <link rel="stylesheet" href="assets/css/viewproduct.css">
    ...
    <h2 style="text-align: center">Recieved Products</h2>
  ...
  <tbody>
      <%
         recievedProductsDAO bd=new recievedProductsDAO(connectionProvider.getConnection());
         ArrayList<recievedProducts> br=bd.getRecievedProduct(u.getEmail());
         for(recievedProducts b:br){
